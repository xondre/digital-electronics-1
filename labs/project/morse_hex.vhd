...
entity morse_hex is
    port(
        ...
        reset   : in  std_logic;
        but  : in std_logic;
        hex : out std_logic_vector(19 - 1 downto 0)
    );
end entity morse_hex;

------------------------------------------------------------
-- Architecture declaration for traffic light controller
------------------------------------------------------------
architecture Behavioral of morse_hex is
...
--    signal s_state : t_state;
    ...
    -- Sample
    signal s_smp : std_logic_vector(1 downto 0);
    
    -- Local delay counter
    signal s_cnt1 : std_logic_vector(4 downto 0);
...
--    -- the frequency of the clock signal is 100 MHz.
    cnt_up1 : entity work.cnt_up_down
        generic map(
            g_CNT_WIDTH => 5
